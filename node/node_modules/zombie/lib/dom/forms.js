...
DOM.HTMLFormElement.prototype.submit = function (button) {
  ...
  function addFieldToParams(field) {
    ...
    if (!name) {
      ...
      var selected = _core.Array.from(field.options).filter(function (option) {
    ...
    case 'radio':
      {
        ...
        if (input.checked) click();else {
          (function () {
            ...
            var checked = _core.Array.from(radios).filter(function (radio) {
            ...
            if (radioResult === false) {
              input.checked = false;
              _core.Array.from(radios).filter(function (radio) {
