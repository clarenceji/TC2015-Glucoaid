...
//        let path = UIBezierPath()
        ...
        var cgpointArray = [
            CGPoint(x: x.axis.inset, y: self.bounds.height - self.y.scale(0) - y.axis.inset),
            CGPoint(x: x.axis.inset, y: self.bounds.height - self.y.scale(data[0]) - y.axis.inset)
        ]
...
//        path.addLineToPoint(CGPoint(x: x.axis.inset, y: self.bounds.height - self.y.scale(data[0]) - y.axis.inset))
        ...
        for index in 1..<data.count {
            ...
            cgpointArray.append(CGPoint(x: x1, y: y1))
...
//        path.addLineToPoint(CGPoint(x: self.x.scale(CGFloat(data.count - 1)) + x.axis.inset, y: self.bounds.height - self.y.scale(0) - y.axis.inset))
        ...
        cgpointArray.append(CGPoint(x: self.x.scale(CGFloat(data.count - 1)) + x.axis.inset, y: self.bounds.height - self.y.scale(0) - y.axis.inset))
        // move to origin
//        path.addLineToPoint(CGPoint(x: x.axis.inset, y: self.bounds.height - self.y.scale(0) - y.axis.inset))
        cgpointArray.append(CGPoint(x: x.axis.inset, y: self.bounds.height - self.y.scale(0) - y.axis.inset))
